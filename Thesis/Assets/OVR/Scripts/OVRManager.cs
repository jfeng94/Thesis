...
#region Unity Messages
	...
	// This function is Start() in the original oculus plugin. It was changed to onEnable to allow
	// switching between MonoCameraRig, DualCameraRig, and OVRCameraRig. Basically this initialization
	// needs to be done every time OVRCameraRig is enabled. Many people online had the same issue
	// and implemented similar solutions. e.g. 
	// https://forums.oculus.com/viewtopic.php?f=37&t=21540
	// -Jeff Picard
